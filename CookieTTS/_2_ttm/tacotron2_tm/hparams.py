...
def create_hparams(hparams_string=None, verbose=False):
    ...
    hparams = HParams(
        ...
        # if data_source is 1:
        dataset_folder = '/content/cookietts/CookieTTS/_0_download/downloads',
        dataset_audio_filters= ['*.wav','*.flac',],
        dataset_audio_rejects= ['*_Very Noisy_*',],
        dataset_p_val = 0.05,# portion of dataset for Validation # default of 0.5% may be too small depending on the size of your dataset.
        ...
        inference_equally_sample_speakers=False,# Will change the 'inference' results to use the same number of files from each speaker.
        ...
        TemporalInfGAN = False,# True  = use Causal Temporal Convs
